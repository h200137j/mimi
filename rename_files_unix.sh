...
# Script to rename files in the Michelle folder with random numbers from 1 to 746
...
if [ $file_count -ne 746 ]; then
    echo "Warning: Found $file_count files, but expected 746."
...
# Generate shuffled numbers from 1 to 746
echo "Generating and shuffling numbers..."
seq 1 746 | shuf > "$temp_dir/shuffled_numbers.txt"
